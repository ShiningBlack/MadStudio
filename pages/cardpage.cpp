...
#include "../madwidgets/cardwidget.h"
#include <QVBoxLayout>
#include <QPushButton>
#include <QLabel>
    ...
    , ui(new Ui::CardPage)
{
    ...
    // 基础卡片
    Mad::CardWidget *basicCard = new Mad::CardWidget(this);
    ...
    // 可点击卡片
    Mad::CardWidget *clickableCard = new Mad::CardWidget(this);
    ...
    connect(clickableCard, &Mad::CardWidget::clicked, []() {
        qDebug() << "卡片被点击了！";
    });
    cardsLayout->addWidget(clickableCard);

    // 带按钮的卡片
    Mad::CardWidget *buttonCard = new Mad::CardWidget(this);
    ...
    // 带多个控件的卡片
    Mad::CardWidget *multiWidgetCard = new Mad::CardWidget(this);
